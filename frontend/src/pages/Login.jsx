...
return (
  ...
  {loading?(<h1>Loading...</h1>):(<div className="flex justify-center">
       <div className="flex flex-col justify-center items-center md:flex-row shadow-md rounded-xl  maxw-7xl w-[90%] md:w-[50%] md:mt-[140px]"  >
         ...
         items-center justify-center flex">
           ...
           space-y-2 m-2">
             ...
             <h1 className='m-2 p-1' >Register to Social Media</h1>
