    ...
    <div className='bg-gray-100 min-h-screen '>
        <div className="flex justify-center items-center flex-col pt-5">
            <div className="search flex justify-between items-center gap-4 ">
                ...
                />
                <button onClick={fetchUsers} className='px-3 py-2 bg-blue-500 text-white rounded-md'>Search</button>
            </div>

           {
            ...
            (
                ...
                users.map(e=>(
                    <Link className="mt-3 px-3 py-2 bg-gray-300 rounded-md flex justify-center items-center gap-2" to={`/user/${e._id}`} key={e._id}>
