   ...
   <>
    ...
    <div className="bg-white flex justify-between gap-4 p-8 rounded-lg shadow-md max-w-md">
        ...
        <div className="flex flex-col gap-2 ">
          ...
          { 
            user._id === loggedInUser._id ? "":  <button onClick={followHandler} className={`py-2 px-5 text-white rounded-md ${followed?"bg-red-500":"bg-blue-400"}`}>{followed?"Unfollow":"Follow" }</button>
          }
        </div>
    </div>
